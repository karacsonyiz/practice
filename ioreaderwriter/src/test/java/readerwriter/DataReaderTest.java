...
public class DataReaderTest {
   ...
   @Test
   public void wrongFileShouldThrowException() throws DataException, IOException {
       sourceFile = temporaryFolder.newFile();
       Writer fw = new OutputStreamWriter(new FileOutputStream(sourceFile.getAbsoluteFile()), DataReader.CHARSET_UTF8);
       fw.write("1:Fekete István:Téli berek\n" +
               "2:Fekete István\n" +
       ...
       exception.expectMessage("Data corrupted at: 2");

       new DataReader().readBookData(sourceFile.getAbsolutePath(), DataReader.CHARSET_UTF8);
   }
    ...
    @Test
    public void anotherReadBookTest()  throws IOException{
        sourceFile = temporaryFolder.newFile();
        Writer fw = new OutputStreamWriter(new FileOutputStream(sourceFile.getAbsoluteFile()), DataReader.CHARSET_UTF8);
        fw.write("1:Fekete István:Téli berek\n" +
                "2:Fekete István:Tüskevár\n" +
        ...
        fw.close();
        //When
        List<Book> bookList = new DataReader().readBookData(sourceFile.getAbsolutePath());
        //Then
        assertThat(bookList.toString(), equalTo("[1:Fekete István:Téli berek, 2:Fekete István:Tüskevár, 3:Jókai Mór:Az aranyember]"));
    }
}
